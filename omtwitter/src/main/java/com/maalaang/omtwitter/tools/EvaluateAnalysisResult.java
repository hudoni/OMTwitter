 ...
 *
 */
public class EvaluateAnalysisResult {

	public static void main(String[] args) {
		try {
			EvaluateAnalysisResult.addLibraryPath(System.getProperty("user.dir") + "/target/lib/jnisvmlight/");
			...
			pipeline.addConsumer("OMTwitterResultEvaluateConsumer", "com/maalaang/omtwitter/uima/consumer/uima-omtwitter-result-evaluate-consumer.xml");
			pipeline.setConsumerParameter("OMTwitterResultEvaluateConsumer", "evaluationCorpusFile", prop.getProperty("omtwitter.eval.corpus.file"));
			pipeline.setConsumerParameter("OMTwitterResultEvaluateConsumer", "evaluationCorpusDelim", prop.getProperty("omtwitter.eval.corpus.delim"));
			pipeline.setConsumerParameter("OMTwitterResultEvaluateConsumer", "evaluationCorpusFields", prop.getProperty("omtwitter.eval.corpus.fields"));
			pipeline.setConsumerParameter("OMTwitterResultEvaluateConsumer", "namedEntityTags", prop.getProperty("omtwitter.eval.corpus.ne.tags"));
			pipeline.setConsumerParameter("OMTwitterResultEvaluateConsumer", "labelNone", prop.getProperty("omtwitter.eval.corpus.label.none"));
			pipeline.setConsumerParameter("OMTwitterResultEvaluateConsumer", "printResult", Boolean.parseBoolean(prop.getProperty("omtwitter.eval.corpus.print.result")));

			pipeline.run(true, "EvaluateAnalysisResult.xml");
